            ...
            children: [
              ...
              CustomText(
               ...
               SelectableItem(
                ...
                item: labtest, onSelect: () =>  _onSelect(labtest),)),
              ...
              CustomButton(
                ...
                onPressed: () {
                     Navigator.of(context).push(MaterialPageRoute(builder: (ctx)=> LabAppointments()));
...
class SelectableItem extends StatelessWidget {
  const SelectableItem({super.key, this.onSelect,this.selected=false, this.item , this.selectedItems, });
  final bool selected;
  final LabTest? item;
    ...
    return GestureDetector(
     onTap: onSelect,
      child: Container(
        ...
        padding: EdgeInsets.symmetric(vertical: ScallingConfig.verticalScale(10), horizontal: ScallingConfig.scale(15)),
